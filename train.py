...
config = {
    ...
    'pretrained_model_path': r'',
    'model_type': 'x',
    'model_name': 'lp_car_detection',
    'input_shape': (352, 640, 1),
    'train_image_path': r'C:\inz\train_data\lp_car_detection\train',
    'validation_image_path': r'C:\inz\train_data\lp_car_detection\validation',
    'class_names_file_path': r'C:\inz\train_data\lp_car_detection\train\classes.txt',
    'optimizer': 'sgd',
    'lr_policy': 'step',
